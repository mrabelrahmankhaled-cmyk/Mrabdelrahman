        ...
        <div className="flex-1 md:basis-1/2 flex flex-col gap-8 text-right">
          ...
          <div className="flex items-center gap-8 pt-6 border-t border-[#F8F9FA]/10">
            <div className="flex flex-col gap-0.5 text-center">
              <span className="text-[#2A9D8F] text-2xl font-black tabular-nums">150K</span>
              <span className="flex items-center justify-center gap-1.5 text-[#F8F9FA]/50 text-xs">
            ...
            <div className="flex flex-col gap-0.5 text-center">
              <span className="text-[#2A9D8F] text-2xl font-black tabular-nums">200K</span>
              <span className="flex items-center justify-center gap-1.5 text-[#F8F9FA]/50 text-xs">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5">
            ...
            <div className="w-px h-8 bg-[#F8F9FA]/10" />
            <div className="flex flex-col gap-0.5 text-center">
              <span className="text-[#2A9D8F] text-2xl font-black tabular-nums">34.732K</span>
              <span className="flex items-center justify-center gap-1.5 text-[#F8F9FA]/50 text-xs">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5">
