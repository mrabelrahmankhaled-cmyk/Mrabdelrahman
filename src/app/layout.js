...
export const metadata = {
  title: "الدكتور عبدالرحمن خالد | منصتك الأولى لتعلم الكيمياء",
  description: "المنصة التعليمية الرسمية للدكتور عبدالرحمن خالد لتعلم وفهم الكيمياء بأحدث الأساليب.",
  icons: {
    icon: '/icon.png',
  },
};
